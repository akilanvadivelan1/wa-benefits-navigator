...
export const DIAGNOSIS_OPTIONS: Option<DiagnosisStatus>[] = [
  {
    value: "diagnosed",
...
export const INSURANCE_OPTIONS: Option<InsuranceStatus>[] = [
  {
...
export const NEEDS_OPTIONS: Option<SpecificNeed>[] = [
...
export const CAREGIVING_OPTIONS: Option<CaregivingImpact>[] = [
  {
    value: "cannotWork",
...
export const RESIDENCY_OPTIONS: Option<ResidencyStatus>[] = [
  {
    value: "citizenOrLpr",
...
export const DEEP_STEP_META: QuizStepMeta[] = [
  {
