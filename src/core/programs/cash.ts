...
export const ssi: Program = {
  ...
  content: {
    ...
    oneLiner:
      "A monthly cash payment (up to about $994) for children with disabilities in families with limited income and savings.",
    exampleFirst:
      "Imagine the extra costs of raising your child, special equipment, therapies, missed work, add up fast. SSI is a monthly check from the federal government to help with those costs, for children whose disability seriously affects daily life and whose family has limited income. (Officially Supplemental Security Income, or SSI.)",
    whatYouGet: [
...
export const tanf: Program = {
  ...
  content: {
    ...
    oneLiner:
      "Monthly cash to help low-income families with children cover rent, food, and basic needs.",
    exampleFirst:
      "Imagine you had to cut back on work to care for your child and money is tight for rent and groceries. TANF provides a monthly cash payment to help low-income families with children cover basic needs. (Officially Temporary Assistance for Needy Families, or TANF.)",
    whatYouGet: [
