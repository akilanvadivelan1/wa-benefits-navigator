...
import { alwaysPasses, hasAnyCondition } from "../ruleHelpers.ts";

export const able: Program = {
  id: "able",
  category: "savings",
  agency: "Treasurer",
  ...
  content: {
    ...
    oneLiner:
      "A tax-advantaged savings account that lets your child save money without losing SSI or Medicaid.",
    exampleFirst:
      "Imagine you want to save for your child's future, but you are afraid that having more than $2,000 in savings will make them lose SSI or Medicaid. An ABLE account lets your family save well beyond that limit for disability-related needs, without losing benefits, and the growth is tax-free. (Officially the WA State ABLE Savings Program.)",
    whatYouGet: [
...
export const ddetf: Program = {
  ...
  content: {
    ...
    oneLiner:
      "A state-run special needs trust that protects larger savings and inheritances without affecting benefits.",
    exampleFirst:
      "Imagine grandparents want to leave money for your child, or your child receives a settlement, but you worry it will disqualify them from SSI and Medicaid. This state-run trust holds that money safely so it does not count against benefits, and the state even matches part of your enrollment. (Officially the Developmental Disabilities Endowment Trust Fund, or DDETF.)",
    whatYouGet: [
