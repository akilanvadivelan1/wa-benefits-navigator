...
import { alwaysPasses, livingIsOneOf } from "../ruleHelpers.ts";

export const kinship: Program = {
  id: "kinship",
  category: "support",
  agency: "DSHS",
  ...
  content: {
    ...
    oneLiner:
      "Support, information, and some financial help for relatives or close family friends raising a child.",
    exampleFirst:
      "Imagine you are a grandparent suddenly raising your grandchild and you do not know where to turn for help. Kinship programs connect you to information, referrals, and some financial support, even if you are not part of the formal foster system. (Officially Kinship Care and the Kinship Caregivers Support Program, or KCSP.)",
    whatYouGet: [
...
export const parentToParent: Program = {
  id: "parentToParent",
  category: "support",
  agency: "TheArc",
