...
export const dda = {
    ...
    content: {
        ...
        oneLiner: "The main gateway to services like in-home care, respite breaks, therapies, and specialized waivers for children with developmental disabilities.",
        exampleFirst: "Imagine you need a trained helper to assist your child with daily tasks, plus regular breaks so you do not burn out. DDA is the doorway to all of that. Once your child is enrolled, it opens access to in-home care, respite, and special programs called waivers. (Officially the Developmental Disabilities Administration, or DDA.)",
        whatYouGet: [
...
export const esit = {
    ...
    content: {
        ...
        oneLiner: "Free early therapy and family support for children from birth to age 3 who have delays or disabilities.",
        exampleFirst: "Imagine your 18-month-old is not talking yet or is slow to reach milestones, and you are worried. ESIT sends specialists to evaluate your child and provide therapy like speech and physical therapy, often in your home, at no cost. (Officially Early Support for Infants and Toddlers, or ESIT.)",
        whatYouGet: [
...
export const cyshcn = {
    ...
    content: {
        ...
        oneLiner: "A free helper who connects your family to the right services, evaluations, and providers, with no eligibility barriers.",
        exampleFirst: "Imagine your child sees several specialists and none of them talk to each other, and you feel lost. A CYSHCN coordinator acts as your guide, connecting the pieces and helping you find evaluations and providers. Anyone can use it. (Officially the Children and Youth with Special Health Care Needs program.)",
        whatYouGet: [
...
export const respite = {
    ...
    content: {
        ...
        oneLiner: "Short-term care from a trained helper so you, the main caregiver, can rest, run errands, or take a break.",
        exampleFirst: "Imagine you have not slept a full night in months because your child wakes often, and you are exhausted. Respite care sends a trained, caring helper to watch your child so you can rest or take time for yourself. It is short-term help focused on giving you a break. (Officially Respite Care through DDA.)",
        whatYouGet: [
