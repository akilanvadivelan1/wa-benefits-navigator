 ...
 */
import { ageInRange, alwaysPasses, incomeAtOrBelow, } from "../ruleHelpers.js";
export const specialEducation = {
    id: "specialEducation",
    category: "education",
    agency: "OSPI",
...
export const childCareRate = {
    ...
    content: {
        ...
        oneLiner: "Subsidized child care, plus extra payment when your child needs a higher level of care.",
        exampleFirst: "Imagine you need child care so you can work, but your child needs extra support that regular care cannot easily provide. Working Connections helps pay for child care, and the Special Needs Rate adds extra money so a provider can give your child the higher level of care they need. (Officially the Working Connections Child Care Special Needs Rate.)",
        whatYouGet: [
...
export const educationOmbuds = {
    ...
    content: {
        ...
        oneLiner: "A free, neutral state office that helps you understand your rights and resolve concerns with your child's public school.",
        exampleFirst: "Imagine the school says your child does not qualify for services and you do not know what to do next. The Education Ombuds is a free, neutral guide who explains your rights, helps you talk with the school, and shows you your options. (Officially the Governor's Office of the Education Ombuds, or OEO.)",
        whatYouGet: [
