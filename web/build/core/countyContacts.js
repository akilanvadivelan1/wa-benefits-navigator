 ...
 */
export function getLocalContact(programId, county) {
    const statewideKey = programId === "cyshcn"
        ? "cyshcn"
        : programId === "kinship"
            ? "kinship"
            : programId === "parentToParent"
                ...
                : undefined;
    if (!statewideKey)
        return undefined; // program has no county-local contact
...
export const COUNTY_LOCAL_PROGRAMS = ["cyshcn", "kinship", "parentToParent"];
